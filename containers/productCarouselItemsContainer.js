...
import ProductCarouselItems from "../components/productCarouselItems";

const wrapComponent = (Comp) => (
  class ProductCarouselItemsContainer extends Component {
    static propTypes = {
...
registerComponent("ProductCarouselItems", ProductCarouselItems, [
  SortableItem("productCarouselItem"),
  wrapComponent
]);
